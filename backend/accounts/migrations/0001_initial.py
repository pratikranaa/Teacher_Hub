    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_verification_status', models.CharField(choices=[('PENDING', 'Pending'), ('VERIFIED', 'Verified'), ('REJECTED', 'Rejected')], default='PENDING', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matching_algorithm_settings', models.JSONField(default=dict, help_text='Custom settings for teacher matching algorithm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E'), ('Other', 'Other')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('AVAILABLE', 'Available'), ('BUSY', 'Busy'), ('TENTATIVE', 'Tentative')], default='AVAILABLE', max_length=20)),
                ('preferred_subjects', models.JSONField(default=list, help_text='List of preferred subjects for this time slot')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['teacher', 'date', 'status'], name='accounts_te_teacher_64c82d_idx')],
            },
        ),
